...
The estimated survival rates are shown in Fig. 1.

```{r fig1, fig.cap = "Estimated survival rates for 20-year old males and females in the SRKW population. Ribbons represent 95% CIs."}
...
The estimated fecundity rates are shown in Fig. 2.

```{r fig2, fig.cap = "Estimated fecundity rates for 20-year females in the SRKW population. Ribbons represent 95% CIs. "}
...
knitr::kable(newdat,digits = 3, caption = "Estimated time-varying survival rates for 20-year old female and male killer whales from the SRKW population.")
```
...
knitr::kable(newdat_f,digits = 3, caption = "Estimated time-varying fecundity rates for 20-year old female killer whales from the SRKW population. The 'lo' and 'hi' values represent 95% confidence intervals")
```
