...
```{r fig1, fig.cap="Estimated fecundity rates for 20-year females in the SRKW population. Ribbons represent 95% CIs."}
...
```{r fig2, fig.cap="Estimated fecundity rates for 20-year females in the SRKW population versus total SRKW population size.  "}
...
```{r}
# 2020-2022 updated: https://waves-vagues.dfo-mpo.gc.ca/library-bibliotheque/41195528.pdf
nrkw = data.frame("year"=1976:2022,
...
```{r fig4, fig.cap = "Combined time series of SRKW + NRKW populations"}
...
```{r fig5, fig.cap = "Estimated fecundity rates for 20-year females in the SRKW population versus combined (SRKW + NRKW) population size."}
